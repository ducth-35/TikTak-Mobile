...
import { FlatList, Text, View, Image, CheckBox } from 'react-native';
import { NavTitleBackHeader, TouchableX, ToggleSwitch } from '@/components';
...
export const Balance = () => {
    ...
    const Coin = SUPPORTED_COINS.filter((item) => item.id === 'ufx' || item.id === 'vndt')
